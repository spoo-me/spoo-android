 ...
 */
fun friendlyError(e: Throwable, fallback: String): FriendlyError = when (e) {
    is SpooIOException ->
...
private fun errorField(field: String?): ErrorField? = when (field) {
 ...
 */
private fun cleanServerMessage(e: SpooApiException, fallback: String): String {
